...
public class ThreadTest4 {
            ...
            public void run() {
                synchronized (object){
                    try {
                        object.wait();
                        System.out.println();
                        System.out.println("唤醒后 t 的状态是： " + Thread.currentThread().getState());
                        System.out.println();
     ...
     *
     *  当前打印第1条，t 的状态： WAITING
     *
     *  当前打印第2条，t 的状态： WAITING
     *
     *  当前打印第3条，t 的状态： WAITING
     *
     *  当前打印第4条，t 的状态： WAITING
     *
     *  当前打印第0条，t 的状态： WAITING
     *
     *  ====用t2来唤醒====
     *
     *  唤醒后 t 的状态是： RUNNABLE
     *
     *  当前打印第1条，t 的状态： TERMINATED
     *
     *  当前打印第2条，t 的状态： TERMINATED
     */
}
